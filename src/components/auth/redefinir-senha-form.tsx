...
/**
 * Formulário de nova senha, usado pelas duas áreas. Os destinos entram por prop
 * pelo mesmo motivo do EsqueciSenhaForm.
 */
            ...
            <div className="min-h-screen flex items-center justify-center bg-background p-4">
                <div className="w-full max-w-sm rounded-3xl border border-border bg-card p-8 space-y-8">
                    ...
                    <div className="text-center space-y-4 rounded-2xl border border-border bg-muted/40 p-6">
                        ...
                        <Link href={esqueciHref} className="text-primary text-sm font-medium hover:underline inline-block">
                            Esqueci minha senha
                        </Link>
                    </div>
                </div>
