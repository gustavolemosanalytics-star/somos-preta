                    ...
                    <CardContent>
                        {confirm ? (
                            <div className="text-center space-y-4 py-4">
                                ...
                                <Link href="/criador/login" className="text-emerald-500 text-sm font-medium hover:underline inline-block">Ir para o login</Link>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <p className="text-center text-sm text-muted-foreground">
                                    Já tem conta? <Link href="/criador/login" className="text-emerald-500 hover:underline font-medium">Fazer login</Link>
                                </p>
                            </form>
                        )}
                    </CardContent>
